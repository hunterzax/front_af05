                                ...
                                >
                                    ...
                                    <div className={`grid grid-cols-1 gap-2 pt-4`}>
                                        ...
                                        <div>
                                            ...
                                            >
                                                {(Array.isArray(dataContractOriginal) ? dataContractOriginal : []).map((item: any, index: number) => (
                                                    <MenuItem key={item?.id || `dataContractOriginal_${index}`} value={item?.id || ''}>
                                                        {item?.contract_code || ''}
                                                    </MenuItem>
                                                ))}
                                            </Select>

...
const ClientPage: React.FC<ClientProps> = () => {
    ...
    useEffect(() => {
      const tdataMode = dataMode?.filter((itemx: any) => srchZone !== undefined ? srchZone.toLowerCase() == (itemx?.zone || '').toLowerCase() : true)
    }, [dataZoneMasterZ])
    
    useEffect(() => {
        const tdataMode = dataMode?.filter((itemx: any) => (srchZone !== undefined && srchZone !== "") ? srchZone.toLowerCase() == (itemx?.zone || '').toLowerCase() : true)
    }, [dataMode])
